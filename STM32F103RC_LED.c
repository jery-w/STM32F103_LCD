...
const uint16_t BUTTON_PIN_SOURCE[BUTTONn] = {BUTTON_EXTI_PIN_SOURCE};

const uint16_t BUTTON_PORT_SOURCE[BUTTONn] = {BUTTON_EXTI_PORT_SOURCE};

GPIO_TypeDef* BUTTON_PORT[BUTTONn] = {BUTTON_GPIO_PORT}; 

const uint16_t BUTTON_PIN[BUTTONn] = {BUTTON_PIN}; 

const uint32_t BUTTON_CLK[BUTTONn] = {BUTTON_GPIO_CLK};

const uint16_t BUTTON_EXTI_LINE[BUTTONn] = {BUTTON_EXTI_LINE};

const uint16_t BUTTON_IRQn[BUTTONn] = {BUTTON_EXTI_IRQn};					 
